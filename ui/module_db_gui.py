...
class Ui_ModuleDBWidget(object):
    ...
    def retranslateUi(self, ModuleDBWidget):
        ...
        self.spacerCB_3.setItemText(0, _translate("ModuleDBWidget", "Ready For Mounting"))
        self.spacerCB_3.setItemText(1, _translate("ModuleDBWidget", "Mounted"))
        self.spacerCB_3.setItemText(2, _translate("ModuleDBWidget", "To Be Tested"))
        ...
        self.treeWidget.headerItem().setText(5, _translate("ModuleDBWidget", "Description"))
        self.treeWidget.headerItem().setText(6, _translate("ModuleDBWidget", "Connections"))
