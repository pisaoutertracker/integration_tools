...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.placeholdersHelpLabel.setTextFormat(QtCore.Qt.PlainText)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.connectPowerLabel)
