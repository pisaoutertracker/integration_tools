...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.caenWidget.setMinimumSize(QtCore.QSize(60, 100))
        self.caenWidget.setObjectName("caenWidget")
        self.caenLayout = QtWidgets.QHBoxLayout(self.caenWidget)
        self.caenLayout.setObjectName("caenLayout")
        self.caenChannelLayout = QtWidgets.QVBoxLayout()
        self.caenChannelLayout.setObjectName("caenChannelLayout")
        ...
        self.channelLayout.addWidget(self.lvOnButton)
        self.lvOffButton = QtWidgets.QPushButton(self.caenWidget)
        self.lvOffButton.setObjectName("lvOffButton")
        self.channelLayout.addWidget(self.lvOffButton)
        self.lvLed = QtWidgets.QFrame(self.caenWidget)
        self.lvLed.setMinimumSize(QtCore.QSize(30, 30))
        self.lvLed.setFrameShape(QtWidgets.QFrame.Box)
        self.lvLed.setObjectName("lvLed")
        self.channelLayout.addWidget(self.lvLed)
        self.lvLabel = QtWidgets.QLabel(self.caenWidget)
        self.lvLabel.setObjectName("lvLabel")
        self.channelLayout.addWidget(self.lvLabel)
        self.caenChannelLayout.addLayout(self.channelLayout)
        self.channelLayout2 = QtWidgets.QHBoxLayout()
        self.channelLayout2.setObjectName("channelLayout2")
        self.hvOnButton = QtWidgets.QPushButton(self.caenWidget)
        self.hvOnButton.setObjectName("hvOnButton")
        self.channelLayout2.addWidget(self.hvOnButton)
        self.hvOffButton = QtWidgets.QPushButton(self.caenWidget)
        self.hvOffButton.setObjectName("hvOffButton")
        self.channelLayout2.addWidget(self.hvOffButton)
        self.hvLed = QtWidgets.QFrame(self.caenWidget)
        self.hvLed.setMinimumSize(QtCore.QSize(30, 30))
        self.hvLed.setFrameShape(QtWidgets.QFrame.Box)
        self.hvLed.setObjectName("hvLed")
        self.channelLayout2.addWidget(self.hvLed)
        self.hvLabel = QtWidgets.QLabel(self.caenWidget)
        self.hvLabel.setObjectName("hvLabel")
        self.channelLayout2.addWidget(self.hvLabel)
        self.caenChannelLayout.addLayout(self.channelLayout2)
        self.caenLayout.addLayout(self.caenChannelLayout)
        self.verticalLayout_6.addWidget(self.caenWidget)
        ...
        self.plotWidget.setMinimumSize(QtCore.QSize(64, 64))
